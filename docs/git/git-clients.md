...
There are many other Git GUI tools listed on [git-scm.com](http://git-scm.com/downloads/guis) for Linux, MacOSX and Windows.  A very comprehensive Git GUI is [SourceTree for MacOSX & Windows](http://www.sourcetreeapp.com/)
